...
// Константы для настоящей Секки
const SEKA_RULES = {
  DECK_SIZE: 37, // 36 карт + Джокер
  CARDS_PER_PLAYER: 3,
  ANTE_AMOUNT: 10,
  STARTING_CHIPS: 1000,
  MAX_PLAYERS: 7,
...
// Ранги карт для сравнения комбинаций
const CARD_RANKS = {
...
class SekaGame {
  ...
  // Создание колоды с Джокером
  createDeck() {
    this.deck = [];
    const suits = ['hearts', 'diamonds', 'clubs', 'spades'];
    const ranks = ['6', '7', '8', '9', '10', 'J', 'Q', 'K', 'A'];
    
    // Создаем стандартные 36 карт
    ...
    console.log(`🃏 Создана колода: ${this.deck.length} карт (36 + Джокер)`);
    return this.deck;
  }
